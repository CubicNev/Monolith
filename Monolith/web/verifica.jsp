<%-- 
    Document   : verifica
    Created on : 2/12/2017, 05:00:32 PM
    Author     : memo0
--%>
...
<html>
    ...
    <body class="container-fluid">
        ...
        <form class="form-register " role="form" id="registro" method="POST" action="verifica2.jsp" >
            <h2 class="form-titulo">Verificacion</h2>
            <div class="contenedor-inputs container-fluid ">
                ...
                <div class="form-group row" style="width:100%;">
                    <div class="col-6">
                        <label class="entrada"  >Texto</label>
                    </div>
                    <div class="col-6">
                        <input type="text" class="form-control" style="width:100%;margin-top:10px;" id="Texto" name="Texto" placeholder="Texto" required="">
                    </div>
                </div>
                <div class="col-12" style="padding-left:40%;padding-right:40%;">
                    <input class="registro"  type="submit" id="Envio" value="Registrar">
                </div>
